    ...
    let newDiv = `
        <div class="team-box item">
            <div class="team-image">
                <img src="product-hotspot/images/products/glass-cup${i}.png" alt="image">
            </div>
            <div class="team-text">
                <a onclick="morphic_window('morphic-window1','product-hotspot/images/products/glass-cup${i}.png');" class="btn btn-medium btn-rounded btn-trans text-capitalize mt-3 mb-5 mb-md-0">View Detail</a>
            </div>
        </div>
    `;
    $(".owl-products").append(newDiv);
}
...
function morphic_window(x,imgSrc) {
    openmodal(x,imgSrc);
}

function openmodal(x,imgSrc){
    $('#morphic-window-img').attr('src',imgSrc);
